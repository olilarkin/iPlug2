...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugRealityView Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugRealityView Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugRealityView Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugRealityView installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugRealityView Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugRealityView installer\n"
