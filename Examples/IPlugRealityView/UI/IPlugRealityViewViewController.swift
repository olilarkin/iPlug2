...
@objc class IPlugRealityViewViewController: IPlugCocoaViewController {
  lazy var state = IPlugRealityViewState(beginEdit: self.beginInformHostOfParamChangeFromUI,
