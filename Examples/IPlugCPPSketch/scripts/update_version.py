...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugCPPSketch-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugCPPSketch-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugCPPSketch-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugCPPSketch-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugCPPSketch-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugCPPSketch.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugCPPSketch.iss",inplace=1):
