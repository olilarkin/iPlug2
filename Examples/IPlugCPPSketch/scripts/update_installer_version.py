...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugCPPSketch Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugCPPSketch Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugCPPSketch Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugCPPSketch installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugCPPSketch Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugCPPSketch installer\n"
