...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugShaderBrowser Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugShaderBrowser Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugShaderBrowser Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugShaderBrowser installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugShaderBrowser Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugShaderBrowser installer\n"
