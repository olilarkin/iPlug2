...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugShaderBrowser-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugShaderBrowser-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/IPlugShaderBrowser-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugShaderBrowser-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugShaderBrowser-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/IPlugShaderBrowser.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugShaderBrowser.iss",inplace=1):
