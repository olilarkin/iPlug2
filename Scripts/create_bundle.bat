...
REM Store paths without embedded quotes; concatenating BundleDir with broken quoting failed on paths with spaces
REM (e.g. Program Files\Common Files\...) as IF EXIST "...\bundle.vst3"\Contents\... confuses cmd.exe.
SET "BundleDir=%~f1"
SET "IconSource=%~f2"
SET "Format=%~3"
