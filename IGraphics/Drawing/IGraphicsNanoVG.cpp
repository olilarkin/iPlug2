...
//    #endif
    ...
    #pragma comment(lib, "opengl32.lib")
      ...
      #define NANOVG_GL3_IMPLEMENTATION
    #else
      #if defined IGRAPHICS_ANGLE
        #if defined IGRAPHICS_GLES2
          #define NANOVG_GLES2_IMPLEMENTATION
        #elif defined IGRAPHICS_GLES3
          #define NANOVG_GLES3_IMPLEMENTATION
        #else
          #error Define either IGRAPHICS_GLES2 or IGRAPHICS_GLES3 when using IGRAPHICS_ANGLE and IGRAPHICS_NANOVG with OS_WIN
        #endif
      #else
...
{  
#if defined IGRAPHICS_METAL
  mVG = nvgCreateContext(pContext, NVG_ANTIALIAS | NVG_TRIPLE_BUFFER /*| NVG_STENCIL_STROKES*/); //NVG_STENCIL_STROKES currently has issues
#else
